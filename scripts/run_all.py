...
Reproduces every paper deliverable from the FROZEN Phase 2A-2F result JSONs:
...
from glasschip.analysis.load_results import load_all, write_manifest
from glasschip.analysis import make_figures, make_tables
from glasschip.validation import validate_results, verify_artifacts
