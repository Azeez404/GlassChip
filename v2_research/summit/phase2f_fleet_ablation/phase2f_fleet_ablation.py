...
import observability_ablation as p2b  # noqa: E402  (frozen, imported read-only)

CLEANED = Path("v2_research/summit/derived/cleaned")
OUT = Path("v2_research/summit/phase2f_fleet_ablation")
SEED = 0
N_BOOT = 2000
...
def main() -> int:
    ...
    results = {
        ...
        "source": "imports frozen v2_research/summit/observability_ablation "
    ...
    (OUT / "phase2f_results.json").write_text(json.dumps(results, indent=2, default=str))
