...
OUT = Path("v2_research/summit/phase2c_bootstrap")
CLEANED = Path("v2_research/summit/derived/cleaned")
P2B_JSON = Path("v2_research/summit/observability_ablation/observability_ablation_results.json")
...
def main():
    ...
    results["table"] = table
    (OUT / "phase2c_bootstrap_results.json").write_text(json.dumps(results, indent=2, default=str))
    import csv
